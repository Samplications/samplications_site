...
import tiktakLogo from "../../assets/tiktak.webp"
  ...
  return (
    <div class="pageContent">
      <div class={styles.content}>
          ...
          <div>
			<h2 class={styles.content_title}>TikTak</h2>
			<h2>About</h2>
          ...
          <img src={tiktakLogo} alt='tiktak logo'/>
        </div>     
        ...
        <p>
		  Sam Bammens built the TikTak app as
		  a Free app. This SERVICE is provided by
		  Sam Bammens at no cost and is intended for use as
		  is.
		</p> <p>
		  ...
		  TikTak unless otherwise defined in this Privacy Policy.
		  ...
		  I request will be retained on your device and is not collected by me in any way.
			...
			by the app
		  </p> <ul><li><a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer">Google Play Services</a></li><li><a href="https://support.google.com/admob/answer/6128543?hl=en" target="_blank" rel="noopener noreferrer">AdMob</a></li>
